    ...
    <section id="skills" className="py-32 relative overflow-hidden" ref={ref}>
      ...
      <div className="relative max-w-6xl mx-auto px-6">
        ...
        <motion.div
          ...
          className="flex gap-0 mb-10 border border-white/8 rounded-xl overflow-x-auto w-fit max-w-full no-scrollbar"
          ...
          {skills.map((cat, i) => {
            ...
            return (
              <button
                ...
                className="relative px-4 sm:px-5 py-2.5 font-mono text-[11px] sm:text-xs whitespace-nowrap shrink-0 transition-all duration-300"
                style={{
        ...
        <div className="grid lg:grid-cols-[1fr_380px] gap-8">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {/* Rings grid */}
              <div className="grid grid-cols-3 sm:grid-cols-5 lg:grid-cols-4 xl:grid-cols-5 gap-x-3 sm:gap-x-4 gap-y-6">
